...
Some of my specialties are Spring Framework, JBoss Drools, JBoss JBpm workflow engine, Apache Camel, Java, JQuery, AngularJS, SQL.
...
*I am a team player always ready to help everyone, helping model a high performance award-winning team in a rapidly growing organization.
